...
\includegraphics[width=0.2\textwidth,valign=c]{IMG_7909.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8080.jpg} & 
Used a power supply board and a bread board from my Arduino kit, prepare to solder the wires. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8082.jpg} & 
Soldered the pin to the transducer driver board. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8084.jpg} & 
...
\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8745.jpg} 
\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8746.jpg} 
\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8748.jpg} & 
Measuring the dimension of the surface transducer for designing housing for the spring reverb. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8749.jpg} & 
 Design and FDM 3D printed a hook that i will glue to the surface tranducer to hold the spring. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8767.jpg} & 
 Glued the hook to the surface transducer.\\ 
\hline

\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8770.jpg}
\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8771.jpg}
\includegraphics[width=0.066\textwidth,,valign=c]{IMG_8772.jpg} & 
Doing some measurement on the piezo pickup for designing housing for spring reverb. \\ 
\hline

\includegraphics[width=0.1\textwidth,,valign=c]{IMG_8773.jpg}
\includegraphics[width=0.1\textwidth,,valign=c]{IMG_8774.jpg} & 
Designed the housing for spring reverb in Fusion 360, output to PrusSlicer for printing on SLA resin printer. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8776.jpg} & 
 Also designed a seperated version to glue on together later, just to make sure at least one version will be available.\\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8779.jpg} & 
SLA resin print finished \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8783.jpg} & 
Post processing done \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_8784.jpg} & 
Mount components to the housing, dimension seems correct. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9382.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9383.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9384.jpg} & 
Connect the 3 piece using duct tape, so the joint (foam tape) is flexible and able to absorb vibrations.\\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9385.jpg} & 
Installed all the components to the housing. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9593.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9594.jpg} & 
Take the speaker cable connector from my DIY bookshelf speaker \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9596.jpg} & 
Connected the cable connector to the surface transducer. \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9597.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9603.jpg} & 
...
\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9604.jpg} & 
Now the surface transducer is permanently mounted to the housing plate.  \\ 
\hline

\includegraphics[width=0.2\textwidth,,valign=c]{IMG_9605.jpg} & 
